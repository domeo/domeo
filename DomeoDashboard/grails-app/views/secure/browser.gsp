...
<script type="text/javascript">
	...
	function getProvenance(item) {
		return 'By ' + item.lastAnnotationSetIndex.lastVersion.createdBy.displayName + ' (et al) on ' + item.lastAnnotationSetIndex.lastVersion.createdOn + ' with v. ' + item.lastAnnotationSetIndex.lastVersion.versionNumber;
	}
