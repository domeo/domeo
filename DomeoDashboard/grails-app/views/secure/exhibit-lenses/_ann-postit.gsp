	<div ex:role="lens" ex:itemTypes="ao:Note, ao:Erratum, ao:Example, ao:Tag, ao:Description" style="display: none" width="100%">
					...
					<div class="topBar">
						<div class="titleBar"><span ex:content=".label"></span> 
				       	...
				       	<div class="provenanceBar">
				       		Last saved on <span ex:content=".lastSavedOn"></span> <span ex:if-exists=".version">with version <span ex:content=".version"></span>
				       	</div>
				    </div>
				</td>
				<td>
					<div class="miscBar">
			       		...
			       		<!-- <img src="${resource(dir:'images/secure',file:'16-star-cold.png',plugin:'users-module')}"/>  Follow annotation -->
			       	</div>
				</td>
			</tr>
	    </table>
