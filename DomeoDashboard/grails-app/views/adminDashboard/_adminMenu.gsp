...
<ul id="navlist">
<li id="active"><g:link controller="adminDashboard" action="listGroups">List Groups</g:link></li>
<li><g:link controller="adminDashboard" action="searchGroup">Search Groups</g:link></li>
<li><g:link controller="adminDashboard" action="createGroup">Create Group</g:link></li>
</ul>
<%-- 
