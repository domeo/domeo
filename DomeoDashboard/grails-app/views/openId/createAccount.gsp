  ...
  <div class="header">
    <div class="header_resize">
      ...
      <div class="slider" style="border-top: 0px solid #CC3300;padding-top: 10px; color: white;" align="center">
			...
			<br/>
			<br/>
                <img src="${resource(dir: 'images/public', file: 'face-sad.png')}"/> No user was found with that OpenID</div> 
                <br/>
       <div class="clr"></div>
      </div>
      <div class="clr"></div>
  	...
  	<div class="content">
		...
		<g:if test='${openId}'>
		You can <g:link controller="public" action="signup">sign up</g:link> now and associate your OpenID with that account.
		<br/>
