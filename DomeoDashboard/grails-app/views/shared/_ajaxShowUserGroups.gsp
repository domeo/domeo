...
<div class="sectioncontainer">
	<div class="dialog" style="width: 660px">
		<fieldset>
			...
			<div>
			<span class="button">
				<g:link class="edit" controller="adminDashboard" action="manageUserGroups"  id="${item.id}" style="text-decoration: none;"><img src="${resource(dir: 'images/dashboard', file: 'edit_group.png')}" alt="Manage Groups" />Manage Groups</g:link>
			</span>
			&nbsp;
			<span class="button">
				<g:link controller="adminDashboard" action="addUserGroups" id="${item.id}" style="text-decoration: none;"><img src="${resource(dir: 'images/dashboard', file: 'add_group.png')}" alt="Add Groups" />Add Groups</g:link>
			</span>
			</div>
		</fieldset> 
	</div>
