...
<html>
	...
	<body>
	  	...
	  	<script type="text/javascript">
		  	...
		  	$(document).ready(function() {
			  	...
			  	*/
			  	...
			  	$.ajax({
			  	  	url: "/DomeoDashboard/ajaxDashboard/userGroups",
		...
		<table>
			<tr>
				<td valign="top" width="400px"><g:render template="/shared/readOnlyUser" /></td>
				<td valign="top">
					<%-- g:render template="/users/ajaxShowUserCommunities" / --%>
    				<g:render template="/shared/ajaxShowReadOnlyUserGroups" />
