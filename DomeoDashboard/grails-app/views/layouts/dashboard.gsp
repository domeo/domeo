	...
	<div id="maincontainer">
		...
		<div id="leftcolumn">
			<div class="logo">
				...
				<h1>
					DOMEO<img src="${resource(dir: 'images/public', file: 'domeo_logo.png')}" width="82" height="65" alt="Domeo Toolkit " /><small>Administrator</small>
				</h1>
				</g:link>
			</div>
	      	<g:render template="/dashboard/administratorMenu" />
		</div>
